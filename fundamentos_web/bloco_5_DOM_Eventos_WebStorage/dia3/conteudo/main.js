...
input.addEventListener("input", trocaNome);
...
function abrePagina(event){
  window.location.replace("https://gustavotardin.github.io./")
}
...
function mudaCor(event){
  myWebpage.style.color = 'rgb('+Math.random() * 255+','+Math.random() * 255+','+Math.random() * 255+')'
}
